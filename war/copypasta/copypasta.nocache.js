function copypasta(){
  ...
  copypasta.__sendStats = sendStats;
  copypasta.__moduleName = $intern_4;
  copypasta.__errFn = null;
  copypasta.__moduleBase = $intern_6;
  copypasta.__softPermutationId = $intern_7;
  copypasta.__computePropValue = null;
  copypasta.__getPropMap = null;
  copypasta.__installRunAsyncCode = function(){
  }
  ;
  copypasta.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  copypasta.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  copypasta.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  copypasta.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[copypasta.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (copypasta.__errFn) {
        script.onerror = function(){
          copypasta.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  copypasta.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  copypasta.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    copypasta.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return copypasta.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    copypasta.__getPropMap = function(){
      var result = {};
    ...
    ;
    copypasta.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = copypasta.__getPropMap;
    ...
    copypasta.__softPermutationId = softPermutationId;
  ...
  processMetas();
  copypasta.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = copypasta.__moduleBase;
